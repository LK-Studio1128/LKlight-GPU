...
**CUDA-batched docking engine — LKlight v4 (final).** Full-featured molecular
...
| CPU grid vs original exact | far-field interpolation only: ≤ 0.5 % bound poses; top-5 pose overlap 100 % (±2 Å) |
